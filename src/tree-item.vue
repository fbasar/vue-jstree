<template>
    <li role="treeitem"
        :class="classes"
        :draggable="draggable && (data.draggable==null || data.draggable===true)"
        ...
        <i class="tree-icon tree-ocl" role="presentation" @click="handleItemToggle" v-if="showCheckbox"></i>
        <div :class="anchorClasses" v-on="events">
            <i class="tree-icon tree-checkbox" role="presentation" v-if="showCheckbox && !model.loading && (data.showCheckbox==null || data.showCheckbox===true)"></i>
...
<script>
    export default {
        ...
        created() {
            ...
            if ((this.data.showCheckbox == null || this.data.showCheckbox === true)) {
                events['click'] = this.handleItemClick;
            } else {
                events['click'] = this.handleItemToggle;
            }
